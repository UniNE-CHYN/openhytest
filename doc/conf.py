...
import os
import sys
sys.path.insert(0, os.path.abspath('../openhytest'))
...
htmlhelp_basename = 'OpenHyTestdoc'
...
man_pages = [
    (master_doc, 'openhytest', 'OpenHyTest Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OpenHyTest', 'OpenHyTest Documentation',
     author, 'OpenHyTest', 'One line description of project.',
     'Miscellaneous'),
]
